...
export const debounce = (func: () => any, timeMs: number = 500) => {
...
export const debounceIf = (func: () => any,  timeMs: number = 500,
...
export class DebounceIf {
    ...
    constructor(func: () => any, timeMs: number = 500, ifCond: (() => boolean) | boolean = false) {
        this._func = func
        this._timeMs = timeMs
